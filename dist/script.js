...
const requiredElements = [
    ...
    {
        name: "inputBox",
        element: document.querySelector(".inputBox"),
    },
    {
        name: "movieContainer",
        element: document.querySelector(".movie-container"),
    },
];
...
const showMovies = (movie) => {
    ...
    const { Title, imdbRating, Genre, Released, Runtime, Actors, Plot, Poster } = movie;
